<template>
  <div class="user-container">
    ...
    <my-bread settitle="商品管理" threetitle="商品分类"></my-bread>
    <!-- 输入框 -->
    <el-row>
    ...
    <el-table :data="userlist" style="width: 100%" border>
      ...
      <el-table-column prop="username" label="分类名称" width="300"></el-table-column>
      <el-table-column prop="email" label="级别" width="200"></el-table-column>
      <el-table-column prop="mobile" label="是否有效" width="200"></el-table-column>
